...
public class JFrameInsertInstrument2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFrameInsertInstrument2 frame = new JFrameInsertInstrument2();
	 ...
	 * Create the frame.
	 */
	public JFrameInsertInstrument2() {
		...
		lblNewLabel.setBounds(156, 11, 46, 14);
		contentPane.add(lblNewLabel);
	}

	

	public JTextField getTxt_instrumentame() {
	...
	public JLabel getLbl_satellite() {

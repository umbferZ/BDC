...
public class Bean_File2 extends SimpleBean {
    ...
    /**
     * Instantiates a new bean file 2.
     *
     * @param clumpId the clump id
     * @param flow_70 the flow 70
     * @param flow_160 the flow 160
     * @param flow_250 the flow 250
     * @param flow_350 the flow 350
     * @param flow_500 the flow 500
     * @param hMaxAx_70 the h max ax 70
     * @param hMinAx_70 the h min ax 70
     * @param hMaxAx_160 the h max ax 160
     * @param hMinAx_160 the h min ax 160
     * @param hMaxAx_250 the h max ax 250
     * @param hMinAx_250 the h min ax 250
     * @param hMaxAx_350 the h max ax 350
     * @param hMinAx_350 the h min ax 350
     * @param hMaxAx_500 the h max ax 500
     * @param hMinAx_500 the h min ax 500
     * @param alpha_70 the alpha 70
     * @param alpha_160 the alpha 160
     * @param alpha_250 the alpha 250
     * @param alpha_350 the alpha 350
     * @param alpha_500 the alpha 500
     */
     ...
     * Sets the alpha 160.
     *
     * @param alpha_160 the new alpha 160
     */
     ...
     * Sets the alpha 250.
     *
     * @param alpha_250 the new alpha 250
     */
     ...
     * Sets the alpha 350.
     *
     * @param alpha_350 the new alpha 350
     */
     ...
     * Sets the alpha 500.
     *
     * @param alpha_500 the new alpha 500
     */
     ...
     * Sets the alpha 70.
     *
     * @param alpha_70 the new alpha 70
     */
     ...
     * Sets the flow 160.
     *
     * @param flow_160 the new flow 160
     */
     ...
     * Sets the flow 250.
     *
     * @param flow_250 the new flow 250
     */
     ...
     * Sets the flow 350.
     *
     * @param flow_350 the new flow 350
     */
     ...
     * Sets the flow 500.
     *
     * @param flow_500 the new flow 500
     */
    ...
    /**
     * Sets the h max ax 160.
     *
     * @param hMaxAx_160 the new h max ax 160
     */
    ...
    /**
     * Sets the h max ax 250.
     *
     * @param hMaxAx_250 the new h max ax 250
     */
    ...
    /**
     * Sets the h max ax 350.
     *
     * @param hMaxAx_350 the new h max ax 350
     */
    ...
    /**
     * Sets the h max ax 500.
     *
     * @param hMaxAx_500 the new h max ax 500
     */
    ...
    /**
     * Sets the h max ax 70.
     *
     * @param hMaxAx_70 the new h max ax 70
     */
    ...
    /**
     * Sets the h min ax 160.
     *
     * @param hMinAx_160 the new h min ax 160
     */
    ...
    /**
     * Sets the h min ax 250.
     *
     * @param hMinAx_250 the new h min ax 250
     */
    ...
    /**
     * Sets the h min ax 350.
     *
     * @param hMinAx_350 the new h min ax 350
     */
    ...
    /**
     * Sets the h min ax 500.
     *
     * @param hMinAx_500 the new h min ax 500
     */
    ...
    /**
     * Sets the h min ax 70.
     *
     * @param hMinAx_70 the new h min ax 70
     */

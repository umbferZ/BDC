...
public class Producer_File2 extends Producer<Bean_File2> {
    ...
    protected Class[] columnMappingType() {
        Class[] types = new Class[] {
                int.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class, double.class,
